...
Base-toi sur la richesse et la fluidité des articles du fichier Actualites.json.`,
      ...
      // Photo prompt missions — generated AFTER the article is written
      {
        id: 'prompt-photo-guide',
        agentId: 'agent-guide',
        title: 'Prompts Photo (à coller dans Imagen)',
        objective: 'Illustrations Magazine',
        customAction: 'GENERATE_PHOTO_PROMPT',
        articleInput: true,
        externalLinkOverride: 'https://gemini.google.com/app',
        externalLinkLabel: 'Ouvrir Gemini Imagen',
        agentTypeForApi: 'guide',
        prompt: 'Colle ton article rédigé ci-dessus. L\'outil génère 1 prompt photo par section H2 au style ABC Salles, à coller dans l\'app Gemini (Imagen Pro).',
        tip: 'À utiliser APRÈS la rédaction. Le contexte de chaque section donne un prompt photo fidèle (culture, rituels, ambiance).',
      },
      {
        id: 'prompt-photo-inspiration',
        agentId: 'agent-inspiration',
        title: 'Prompts Photo (à coller dans Imagen)',
        objective: 'Illustrations Magazine',
        customAction: 'GENERATE_PHOTO_PROMPT',
        ...
        externalLinkOverride: 'https://gemini.google.com/app',
        externalLinkLabel: 'Ouvrir Gemini Imagen',
        agentTypeForApi: 'inspiration',
        prompt: 'Colle ton Top / Liste rédigé ci-dessus. L\'outil génère 1 prompt photo par item (H2) au style ABC Salles, à coller dans l\'app Gemini (Imagen Pro).',
        tip: 'Idéal pour les articles "Top 10" : un prompt photo par item de la liste.',
      },
      {
        id: 'prompt-photo-actualite',
        agentId: 'agent-actualite',
        title: 'Prompts Photo (à coller dans Imagen)',
        objective: 'Illustrations Magazine',
        customAction: 'GENERATE_PHOTO_PROMPT',
        ...
        externalLinkOverride: 'https://gemini.google.com/app',
        externalLinkLabel: 'Ouvrir Gemini Imagen',
        agentTypeForApi: 'actualite',
        prompt: 'Colle ton actualité ci-dessus. L\'outil génère 1 prompt photo "newsy" au style ABC Salles, à coller dans l\'app Gemini (Imagen Pro).',
        tip: 'Pour les actus, un seul prompt hero suffit généralement.',
      },
